...
$app->group('/car', function(){
    ...
    $this->get('/{car_license}', function (Request $request, Response $response){
    ...
    $this->delete('/{car_id}', function (Request $request, Response $response){
...
$app->group('/parks', function(){
    ...
    salieron. */
    $this->get('/still_in', function (Request $request, Response $response){
    ...
    /*  devuelve un json de un array de los autos que estan estacionados y ya
        salieron. */
    $this->get('/outed', function (Request $request, Response $response){
        /*  preseteo el array de respuesta. */
        $responseArray = [];
        /*  getAll devuelve un array de parks o bien null. */
    ...
    $this->get('/out_car/license/{car_license}', function (Request $request, Response $response){
    ...
    $this->get('/out_car/{parks_id}', function (Request $request, Response $response){
        /*  preseteo la respuesta. */
        $preJSON = array(   'outed' => false,
                            'parks' => NULL );
