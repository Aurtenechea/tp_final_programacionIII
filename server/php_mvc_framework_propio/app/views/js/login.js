...
function check_loged_in(){
    ...
    var root_url_api = 'http://localhost/utn/programacion3/pruebaJWT/public';
    var url = root_url_api + "/crearToken";
    var params = "mail=nacho&password=qweasdzxc";
    ajax = new Ajax();
